# ============================================================
# Extracted coin configurations from binance_bot-2.py
# ============================================================

# Spot coins: 135 total
SPOT_ALL_COINS = {
    'FLOKIUSDT': {'ma': 255, 'sk': 136, 'sks': 20, 'sd': 12},
    'PEPEUSDT': {'ma': 320, 'sk': 119, 'sks': 33, 'sd': 3},
    'SOLUSDT': {'ma': 245, 'sk': 97, 'sks': 19, 'sd': 19},
    'FETUSDT': {'ma': 230, 'sk': 202, 'sks': 27, 'sd': 27},
    'SUIUSDT': {'ma': 246, 'sk': 139, 'sks': 38, 'sd': 3},
    'SANDUSDT': {'ma': 226, 'sk': 122, 'sks': 28, 'sd': 7},
    'VANRYUSDT': {'ma': 136, 'sk': 20, 'sks': 35, 'sd': 4},
    'BONKUSDT': {'ma': 124, 'sk': 201, 'sks': 58, 'sd': 29},
    'AXSUSDT': {'ma': 249, 'sk': 39, 'sks': 32, 'sd': 3},
    'RAYUSDT': {'ma': 219, 'sk': 154, 'sks': 25, 'sd': 8},
    'ONEUSDT': {'ma': 224, 'sk': 179, 'sks': 28, 'sd': 28},
    'OMUSDT': {'ma': 270, 'sk': 83, 'sks': 45, 'sd': 5},
    'WLDUSDT': {'ma': 280, 'sk': 95, 'sks': 13, 'sd': 4},
    'AVAXUSDT': {'ma': 214, 'sk': 39, 'sks': 34, 'sd': 7},
    'JASMYUSDT': {'ma': 97, 'sk': 51, 'sks': 17, 'sd': 9},
    'DENTUSDT': {'ma': 71, 'sk': 190, 'sks': 46, 'sd': 11},
    'SUPERUSDT': {'ma': 191, 'sk': 133, 'sks': 34, 'sd': 5},
    'RENDERUSDT': {'ma': 112, 'sk': 58, 'sks': 19, 'sd': 7},
    'ETHFIUSDT': {'ma': 219, 'sk': 171, 'sks': 57, 'sd': 23},
    'CHRUSDT': {'ma': 262, 'sk': 197, 'sks': 56, 'sd': 14},
    'ARKMUSDT': {'ma': 185, 'sk': 97, 'sks': 12, 'sd': 20},
    'MANAUSDT': {'ma': 69, 'sk': 129, 'sks': 42, 'sd': 8},
    'ANKRUSDT': {'ma': 227, 'sk': 173, 'sks': 39, 'sd': 28},
    'CTSIUSDT': {'ma': 223, 'sk': 62, 'sks': 11, 'sd': 17},
    'TFUELUSDT': {'ma': 106, 'sk': 160, 'sks': 30, 'sd': 17},
    'DOGEUSDT': {'ma': 241, 'sk': 139, 'sks': 35, 'sd': 16},
    'VTHOUSDT': {'ma': 222, 'sk': 117, 'sks': 33, 'sd': 18},
    'BOMEUSDT': {'ma': 46, 'sk': 160, 'sks': 36, 'sd': 15},
    'ZKUSDT': {'ma': 58, 'sk': 79, 'sks': 23, 'sd': 23},
    'GASUSDT': {'ma': 44, 'sk': 125, 'sks': 32, 'sd': 33},
    'BNTUSDT': {'ma': 102, 'sk': 51, 'sks': 46, 'sd': 6},
    'TAOUSDT': {'ma': 119, 'sk': 129, 'sks': 25, 'sd': 7},
    'CELRUSDT': {'ma': 274, 'sk': 120, 'sks': 31, 'sd': 11},
    'CHZUSDT': {'ma': 119, 'sk': 127, 'sks': 37, 'sd': 31},
    'EGLDUSDT': {'ma': 276, 'sk': 37, 'sks': 29, 'sd': 7},
    'WIFUSDT': {'ma': 153, 'sk': 136, 'sks': 29, 'sd': 26},
    'PENDLEUSDT': {'ma': 284, 'sk': 83, 'sks': 17, 'sd': 6},
    'ROSEUSDT': {'ma': 61, 'sk': 20, 'sks': 59, 'sd': 21},
    'HBARUSDT': {'ma': 224, 'sk': 199, 'sks': 36, 'sd': 5},
    'FILUSDT': {'ma': 52, 'sk': 70, 'sks': 26, 'sd': 14},
    'SUSHIUSDT': {'ma': 235, 'sk': 21, 'sks': 31, 'sd': 23},
    'CRVUSDT': {'ma': 88, 'sk': 36, 'sks': 25, 'sd': 17},
    'LINKUSDT': {'ma': 52, 'sk': 54, 'sks': 30, 'sd': 6},
    'ARBUSDT': {'ma': 57, 'sk': 138, 'sks': 49, 'sd': 24},
    'WINUSDT': {'ma': 161, 'sk': 126, 'sks': 15, 'sd': 10},
    'OSMOUSDT': {'ma': 127, 'sk': 195, 'sks': 50, 'sd': 28},
    'VETUSDT': {'ma': 310, 'sk': 98, 'sks': 11, 'sd': 5},
    'AMPUSDT': {'ma': 258, 'sk': 133, 'sks': 34, 'sd': 3},
    'CFXUSDT': {'ma': 207, 'sk': 183, 'sks': 73, 'sd': 20},
    'RUNEUSDT': {'ma': 147, 'sk': 94, 'sks': 41, 'sd': 5},
    'STXUSDT': {'ma': 306, 'sk': 136, 'sks': 53, 'sd': 12},
    'POLYXUSDT': {'ma': 81, 'sk': 146, 'sks': 26, 'sd': 15},
    'ZROUSDT': {'ma': 112, 'sk': 26, 'sks': 34, 'sd': 30},
    'ZECUSDT': {'ma': 262, 'sk': 86, 'sks': 38, 'sd': 6},
    'SHIBUSDT': {'ma': 315, 'sk': 41, 'sks': 26, 'sd': 5},
    'DUSKUSDT': {'ma': 237, 'sk': 150, 'sks': 71, 'sd': 24},
    'ZILUSDT': {'ma': 243, 'sk': 153, 'sks': 35, 'sd': 3},
    'GALAUSDT': {'ma': 81, 'sk': 181, 'sks': 38, 'sd': 14},
    'ADAUSDT': {'ma': 293, 'sk': 110, 'sks': 34, 'sd': 13},
    'HIGHUSDT': {'ma': 74, 'sk': 140, 'sks': 35, 'sd': 3},
    'ZENUSDT': {'ma': 238, 'sk': 126, 'sks': 23, 'sd': 12},
    'POLUSDT': {'ma': 46, 'sk': 151, 'sks': 19, 'sd': 14},
    'BNBUSDT': {'ma': 203, 'sk': 208, 'sks': 34, 'sd': 3},
    'HOTUSDT': {'ma': 313, 'sk': 120, 'sks': 56, 'sd': 8},
    'GLMUSDT': {'ma': 100, 'sk': 123, 'sks': 14, 'sd': 19},
    'ENJUSDT': {'ma': 183, 'sk': 123, 'sks': 30, 'sd': 36},
    'COTIUSDT': {'ma': 97, 'sk': 98, 'sks': 31, 'sd': 16},
    'SUNUSDT': {'ma': 260, 'sk': 63, 'sks': 34, 'sd': 17},
    'CETUSUSDT': {'ma': 217, 'sk': 20, 'sks': 12, 'sd': 15},
    'BEAMXUSDT': {'ma': 80, 'sk': 141, 'sks': 39, 'sd': 4},
    'PIXELUSDT': {'ma': 58, 'sk': 132, 'sks': 24, 'sd': 16},
    'THETAUSDT': {'ma': 167, 'sk': 147, 'sks': 58, 'sd': 8},
    'SYNUSDT': {'ma': 44, 'sk': 200, 'sks': 37, 'sd': 8},
    'KAIAUSDT': {'ma': 21, 'sk': 96, 'sks': 41, 'sd': 15},
    'UNIUSDT': {'ma': 252, 'sk': 61, 'sks': 36, 'sd': 8},
    'ALGOUSDT': {'ma': 236, 'sk': 148, 'sks': 26, 'sd': 5},
    'ACHUSDT': {'ma': 213, 'sk': 210, 'sks': 65, 'sd': 31},
    'IOTXUSDT': {'ma': 207, 'sk': 199, 'sks': 38, 'sd': 29},
    'RVNUSDT': {'ma': 57, 'sk': 92, 'sks': 37, 'sd': 18},
    'CVCUSDT': {'ma': 91, 'sk': 72, 'sks': 36, 'sd': 11},
    'TWTUSDT': {'ma': 284, 'sk': 80, 'sks': 21, 'sd': 11},
    'LRCUSDT': {'ma': 105, 'sk': 93, 'sks': 29, 'sd': 13},
    'XRPUSDT': {'ma': 179, 'sk': 183, 'sks': 10, 'sd': 5},
    'IQUSDT': {'ma': 99, 'sk': 78, 'sks': 35, 'sd': 10},
    'JOEUSDT': {'ma': 103, 'sk': 149, 'sks': 36, 'sd': 13},
    'IOSTUSDT': {'ma': 58, 'sk': 115, 'sks': 9, 'sd': 33},
    'DOTUSDT': {'ma': 288, 'sk': 94, 'sks': 31, 'sd': 8},
    'TNSRUSDT': {'ma': 65, 'sk': 103, 'sks': 43, 'sd': 35},
    'NEARUSDT': {'ma': 226, 'sk': 153, 'sks': 16, 'sd': 25},
    'CVXUSDT': {'ma': 128, 'sk': 165, 'sks': 25, 'sd': 13},
    'IMXUSDT': {'ma': 276, 'sk': 145, 'sks': 46, 'sd': 9},
    'ETCUSDT': {'ma': 263, 'sk': 72, 'sks': 33, 'sd': 8},
    'AIUSDT': {'ma': 39, 'sk': 84, 'sks': 49, 'sd': 30},
    'XVGUSDT': {'ma': 122, 'sk': 128, 'sks': 45, 'sd': 19},
    'PORTALUSDT': {'ma': 70, 'sk': 133, 'sks': 39, 'sd': 6},
    'ETHUSDT': {'ma': 114, 'sk': 110, 'sks': 40, 'sd': 15},
    'AUCTIONUSDT': {'ma': 84, 'sk': 61, 'sks': 37, 'sd': 39},
    'KAVAUSDT': {'ma': 82, 'sk': 142, 'sks': 46, 'sd': 10},
    'JSTUSDT': {'ma': 238, 'sk': 75, 'sks': 11, 'sd': 27},
    'NFPUSDT': {'ma': 52, 'sk': 146, 'sks': 63, 'sd': 6},
    'ZRXUSDT': {'ma': 253, 'sk': 82, 'sks': 25, 'sd': 5},
    'TRBUSDT': {'ma': 20, 'sk': 102, 'sks': 52, 'sd': 12},
    'MDTUSDT': {'ma': 297, 'sk': 131, 'sks': 21, 'sd': 8},
    'GNOUSDT': {'ma': 134, 'sk': 97, 'sks': 45, 'sd': 20},
    'FLUXUSDT': {'ma': 221, 'sk': 170, 'sks': 29, 'sd': 26},
    'XLMUSDT': {'ma': 91, 'sk': 137, 'sks': 7, 'sd': 5},
    'GRTUSDT': {'ma': 154, 'sk': 143, 'sks': 38, 'sd': 7},
    'ICXUSDT': {'ma': 276, 'sk': 80, 'sks': 45, 'sd': 9},
    'MBLUSDT': {'ma': 79, 'sk': 85, 'sks': 13, 'sd': 31},
    'BLURUSDT': {'ma': 72, 'sk': 153, 'sks': 20, 'sd': 5},
    'ENSUSDT': {'ma': 65, 'sk': 185, 'sks': 30, 'sd': 14},
    'KSMUSDT': {'ma': 160, 'sk': 60, 'sks': 48, 'sd': 21},
    'SCUSDT': {'ma': 300, 'sk': 74, 'sks': 35, 'sd': 15},
    'SNXUSDT': {'ma': 280, 'sk': 87, 'sks': 56, 'sd': 16},
    'ARDRUSDT': {'ma': 306, 'sk': 101, 'sks': 27, 'sd': 16},
    'ICPUSDT': {'ma': 96, 'sk': 166, 'sks': 37, 'sd': 30},
    'XVSUSDT': {'ma': 330, 'sk': 48, 'sks': 22, 'sd': 15},
    'HIVEUSDT': {'ma': 98, 'sk': 162, 'sks': 40, 'sd': 14},
    'INJUSDT': {'ma': 232, 'sk': 220, 'sks': 45, 'sd': 16},
    'LQTYUSDT': {'ma': 202, 'sk': 83, 'sks': 14, 'sd': 17},
    'MOVRUSDT': {'ma': 54, 'sk': 119, 'sks': 40, 'sd': 16},
    'DYDXUSDT': {'ma': 50, 'sk': 139, 'sks': 25, 'sd': 17},
    'CAKEUSDT': {'ma': 30, 'sk': 173, 'sks': 37, 'sd': 28},
    'QNTUSDT': {'ma': 168, 'sk': 215, 'sks': 23, 'sd': 22},
    'XTZUSDT': {'ma': 244, 'sk': 119, 'sks': 29, 'sd': 11},
    'OGNUSDT': {'ma': 307, 'sk': 166, 'sks': 28, 'sd': 17},
    'SEIUSDT': {'ma': 148, 'sk': 179, 'sks': 42, 'sd': 20},
    'STGUSDT': {'ma': 47, 'sk': 68, 'sks': 51, 'sd': 29},
    'SLPUSDT': {'ma': 55, 'sk': 150, 'sks': 20, 'sd': 17},
    'CKBUSDT': {'ma': 110, 'sk': 140, 'sks': 30, 'sd': 15},
    'OPUSDT': {'ma': 280, 'sk': 138, 'sks': 37, 'sd': 24},
    'PHBUSDT': {'ma': 232, 'sk': 86, 'sks': 30, 'sd': 10},
    'WUSDT': {'ma': 157, 'sk': 92, 'sks': 32, 'sd': 14},
    'DGBUSDT': {'ma': 98, 'sk': 125, 'sks': 28, 'sd': 24},
    'BTCUSDT': {'ma': 292, 'sk': 172, 'sks': 31, 'sd': 3},
}

# Futures short coins: 234 total
FUTURES_SHORT_ALL = [
